        ...
        while True:
            ...
            for cam_id, frame in frames.items():
                ...
                for i in range(len(tracked_detections)):
                    ...
                    y_bottom = xyxy[3]
                    current_zone = self.zone_classifier.get_zone_for_point(cam_id, x_center, y_bottom)
...
def main():
    ...
    parser.add_argument("--input-dir", required=True, help="Directory containing CCTV video files")
    parser.add_argument("--output-dir", required=True, help="Directory to write JSONL events")
