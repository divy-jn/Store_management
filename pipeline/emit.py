...
class EventEmitter:
    def __init__(self, store_id: str, output_dir: str):
        ...
        self.output_file = self.output_dir / f"events_{self.store_id}_{timestamp_str}.jsonl"
    ...
    def calculate_timestamp(self, clip_start_time: datetime, frame_number: int, fps: float) -> datetime:
